...
function showStats() {
    ...
    const Uniforme = crearBoton3d('Uniforme', 0xffffff, 0, 0, 'Uniforme_mexico.jpg');
...
const triviaQuestions = [
    {
        question: "En que Mundial fue Mexico sede por primera vez?",
        options: ["1970", "1986", "1966", "1978"],
        correct: 0
    },
    {
        question: "Quien es el maximo goleador histórico de Mexico?",
        options: ["Cuauhtemoc Blanco", "Hugo Sanchez", "Javier Hernandez", "Luis Hernandez"],
        correct: 2
    },
    {
        question: "Que jugador mexicano ha participado en mas Mundiales?",
        options: ["Hugo Sanchez", "Andres Guardado", "Rafael Marquez", "Claudio Suarez"],
        correct: 2
    }
];
const buttonColors = [
...
function showVideo() {
    ...
    video.src = '/assets/videos/mexico.mp4';
    video.loop = true;
    video.muted = false;
...
function showModel() {
    ...
    loader.load('/assets/models/farmacias_similares.glb', (gltf) => {
        if (mixer) {
            mixer.stopAllAction();
            mixer = null;
        }
