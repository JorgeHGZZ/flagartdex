...
function showStats() {
    ...
    const Uniforme = crearBoton3d('Uniforme', 0xffffff, 0, 0, 'Uniforme_canada.webp');
    Uniforme.position.set(0.06, -0.03, -0.2);
    Uniforme.scale.set(0.7, 0.6, 0.4);
    currentStats.push(Uniforme);
}

const triviaQuestions = [
    {
        question: "En que anio clasifico Canada por primera vez a un Mundial?",
        options: ["1978", "1986", "1994", "2002"],
        correct: 1
    },
    {
        question: "Quien es uno de los goleadores mas reconocidos de Canada?",
        options: ["Dwayne De Rosario", "Harry Kewell", "Tim Cahill", "Mark Viduka"],
        correct: 0
    },
    {
        question: "En que confederacion juega Canada?",
        options: ["OFC", "AFC", "CONCACAF", "CONMEBOL"],
        correct: 2
    }
];
...
function showVideo() {
    ...
    video.src = '/assets/videos/canada.mp4';
    video.loop = true;
    video.muted = false;
...
function showModel() {
    ...
    loader.load('/assets/models/canada.glb', (gltf) => {
