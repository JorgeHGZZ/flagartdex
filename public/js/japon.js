...
function showStats() {
    ...
    const Uniforme = crearBoton3d('Uniforme', 0xffffff, 0, 0, 'Uniforme_japon.jpg');
...
const triviaQuestions = [
    {
        question: "En que anio participo Japon por primera vez en un Mundial?",
        options: ["1994", "1998", "2002", "2006"],
        correct: 1
    },
    {
        question: "Cual es el apodo de la seleccion japonesa?",
        options: ["Samurai Blue", "Los Nippon", "Los Azules", "Los Samurai"],
        correct: 0
    },
    {
        question: "Que color predomina en la camiseta titular de Japon?",
        options: ["Rojo", "Azul", "Blanco", "Negro"],
        correct: 1
    }
];
...
function showVideo() {
    ...
    video.src = '/assets/videos/Japon.mp4';
    video.loop = true;
    video.muted = false;
...
function showModel() {
    ...
    loader.load('/assets/models/japon.glb', (gltf) => {
        currentModel = gltf.scene; // ✅ guardar referencia aquí
        currentModel.position.set(0, -0.3, -2);
        currentModel.scale.set(0.1, 0.1, 0.1);
        currentModel.rotation.y = Math.PI; // Rotar 180 grados si es necesario
