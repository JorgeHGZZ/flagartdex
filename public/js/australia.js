...
function showStats() {
    ...
    const Uniforme = crearBoton3d('Uniforme', 0xffffff, 0, 0, 'Uniforme_Australia.avif');
...
const triviaQuestions = [
    {
        question: "En que anio clasifico Australia por primera vez a un Mundial?",
        options: ["1974", "1986", "2006", "1970"],
        correct: 0
    },
    {
        question: "Quien es el maximo goleador historico de Australia?",
        options: ["Tim Cahill", "Harry Kewell", "Mark Viduka", "Mile Jedinak"],
        correct: 0
    },
    {
        question: "En que confederacion juega actualmente Australia?",
        options: ["OFC", "AFC", "UEFA", "CONMEBOL"],
        correct: 1
    }
];
...
function showVideo() {
    ...
    video.src = '/assets/videos/Australia.mp4';
    video.loop = true;
    video.muted = false;
...
function showModel() {
    ...
    loader.load('/assets/models/australia.glb', (gltf) => {
        currentModel = gltf.scene; // ✅ guardar referencia aquí
        currentModel.position.set(0, -0.6, -2);
        currentModel.scale.set(0.02, 0.02, 0.02);
