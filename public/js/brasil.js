...
// En la función showStats()
function showStats() {
    clearSceneSections(); // limpiar antes de crear
    const loader = new FontLoader();

    loader.load('/fonts/helvetiker_regular.typeface.json', function (font) {
        const textGeo = new TextGeometry("Primer Mundial:\n 1930 \n\nN. Participaciones:\n 22 \n\n              Uno de los mas exitosos; \n        5 veces campeones del mundo.", {
            font: font,
            size: 0.03,
            height: 0,
            depth: 0.001,
    ...
    const Uniforme = crearBoton3d('Model', 0xffffff, 0, 0, 'Uniforme_brasil.jpg');
...
const triviaQuestions = [
    {
        question: "En que ano gano Brasil su primera Copa Mundial?",
        options: ["1930", "1958", "1962", "1970"],
        correct: 0
    },
    {
        question: "Quien es el maximo goleador historico de Brasil?",
        options: ["Pelé", "Ronaldo", "Romario", "Neymar"],
        correct: 0
    },
    {
        question: "Contra que equipo gano Brasil la final del Mundial 2002?",
        options: ["Alemania", "Suecia", "Francia", "Italia"],
        correct: 0
    }
];
...
function showVideo() {
    ...
    video.src = '/assets/videos/Brasil.mp4';
    video.loop = true;
    video.muted = false;
...
function showModel() {
    ...
    loader.load('/assets/models/cristo_redentor.glb', (gltf) => {
...
renderer.setAnimationLoop(() => {
    ...
    if (currentModel) {
        currentModel.rotation.y += 0.01; // Ajusta la velocidad de rotación aquí
    }
