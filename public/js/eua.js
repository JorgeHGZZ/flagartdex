...
function showStats() {
    ...
    const Uniforme = crearBoton3d('Uniforme', 0xffffff, 0, 0, 'Uniforme_eua.jpg');
...
const triviaQuestions = [
    {
        question: "Cual fue el mejor resultado de Estados Unidos en un Mundial?",
        options: ["3er lugar", "Cuartos de final", "Octavos de final", "Fase de grupos"],
        correct: 0
    },
    {
        question: "Quien es el maximo goleador historico de Estados Unidos?",
        options: ["Landon Donovan", "Clint Dempsey", "Christian Pulisic", "Eric Wynalda"],
        correct: 0
    },
    {
        question: "En que anio fue Estados Unidos sede del Mundial por primera vez?",
...
function showVideo() {
    ...
    video.src = '/assets/videos/eua.mp4';
    video.loop = true;
    video.muted = false;
